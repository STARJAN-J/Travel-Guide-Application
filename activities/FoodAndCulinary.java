...
public class FoodAndCulinary extends Activity{
    private final String activityType = "Food And Culinary";
    

    public FoodAndCulinary(String location, String duration, String overview, boolean isAvailable, String difiiculty, double price, LocalDate fromDate, LocalDate toDate) {
