...
public class Sightseeing extends Activity{
    private final String activityType = "Sightseeing";
    
    public Sightseeing(String location, String duration, String overview, boolean isAvailable, String difiiculty, double price, LocalDate fromDate, LocalDate toDate) {
