...
public class WaterActivity extends Activity{
    private final String activityType = "Water Activity";
    

    public WaterActivity(String location, String duration, String overview, boolean isAvailable, String difiiculty, double price, LocalDate fromDate, LocalDate toDate) {
